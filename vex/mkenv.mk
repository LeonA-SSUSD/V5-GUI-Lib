...
CXX_FLAGS = ${CFLAGS_CL} ${CFLAGS_V7} -pedantic -Os -Wall -Werror=return-type -frtti -fno-threadsafe-statics -fno-exceptions  -std=gnu++11 -ffunction-sections -fdata-sections $(DEFINES)
